...
import SensorIcon from '../../img/luminaria.svg';
    ...
    return(        
        <Grid item xs={12} sm={6} md={6} lg={4}>
                ...
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item style={{ flexGrow: 1, textAlign: "left" }} minWid>
                        <Typography variant="h6">
                            <strong>Luminosity Sensor {props.sensorID}</strong>
                        </Typography>
                        <Typography><strong>Status:</strong> { sensorValue["0"] ? 'Device Connected' : 'No information available' }</Typography>
                        <Typography> <strong>Luminosity:</strong> {sensorValue["21"] == "1" ? 'Lights On' : 'Lights Off' } </Typography>
                    </Grid>
                </Grid>
            </Paper>
            ...
            <Dialog open={open} keepMounted onClose={closeDialog} fullWidth maxWidth="xs">
                <DialogTitle>
                    <Typography align="left" variant="h6"><strong>Luminosity Sensor at {sensorTopic}</strong></Typography>
                </DialogTitle>
                    ...
                    <TableContainer>
                        ...
                        <TableBody>
                            ...
                            <TableRow >
                                ...
                                <TableCell>{sensorValue["21"] || "unknown"}</TableCell>
                            </TableRow>
                            <TableRow>
